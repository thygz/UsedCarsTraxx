...
export default function ListingSlider({ recommendedListings, carBodytype }) {
    return (
        <Swiper
            slidesPerView={1.25}
            spaceBetween={6}
        ...
        >
            ...
            <SwiperSlide>
                {recommendedListings.length < 5 ? (
                    <Link to={'/search'}>
                        <div className="bg-inherit shadow-md hover:shadow-lg rounded-lg w-[95%] flex flex-col justify-center items-center gap-5 py-[4.95rem] sm:py-[4.72rem] md:py-[4.74rem] xl:py-[5.14rem] group">
